      ...
      <div className='flex gap-10 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col gap-2'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <input type="number" value={Quantity} min={1} className='w-12 text-center border rounded ' /> 
            <button onClick={IncreaseQuantity} className='px-3 py-1 bg-gray-300 rounded hover:bg-gray-400'>+</button> 
            </div>

            <button className='bg-blue-300 rounded-xl text-black px-8 py-3 text-sm cursor-pointer hover:bg-blue-400'>Add to Cart</button>
